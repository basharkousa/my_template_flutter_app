...
class WidgetCarousel extends StatefulWidget {
  ...
  @override
  State createState() => new WidgetCarouselState(currentIndex:currentIndex,onPageChange: onPageChange);
}
...
class WidgetCarouselState extends State<WidgetCarousel> {
  ...
  void initState() {
    super.initState();
     _controller = new PageController(initialPage: currentIndex ?? 0);
    if (widget.autoplay) {
